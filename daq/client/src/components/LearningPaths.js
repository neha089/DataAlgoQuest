        ...
        const fetchProgressData = async () => {
            ...
            const updatedPaths = await Promise.all(learningPaths.map(async (path) => {
                try {
                    ...
                    const totalQuizzes = totalQuizzesResponse.data.quizzes.length;
                    const totalChallenges = totalChallengesResponse.data.challenges.length;
                    ...
                    const solvedQuizzes = solvedQuizzesResponse.data.solvedQuizzes.length;
                    const solvedChallenges = solvedChallengesResponse.data.solvedChallenges.length;
